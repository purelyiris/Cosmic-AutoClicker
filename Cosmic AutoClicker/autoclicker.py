"""
Cosmic Auto Clicker + Macro Recorder
-----------------------------------
Cross-platform (Windows + macOS) auto clicker with a modern Galaxy UI, an
optimized click loop, full mouse+keyboard macro recording/playback,
and fully rebindable hotkeys.

Stack: Python 3.9+, customtkinter (UI), pynput (input control / global hotkeys)
"""
